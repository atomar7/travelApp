...
import com.travel.app.domain.Authority;
import com.travel.app.domain.People;
import com.travel.app.domain.User;
import com.travel.app.repository.AuthorityRepository;
import com.travel.app.repository.UserRepository;
import com.travel.app.security.AuthoritiesConstants;
import com.travel.app.service.MailService;
import com.travel.app.service.PeopleService;
import com.travel.app.service.UserService;
import com.travel.app.web.rest.dto.ManagedUserDTO;
import com.travel.app.web.rest.dto.PeopleDTO;
import com.travel.app.web.rest.dto.UserDTO;
...
public class UserResource {
    ...
    public ResponseEntity<?> createUser(@RequestBody ManagedUserDTO managedUserDTO, HttpServletRequest request) throws URISyntaxException {
        ...
        if (userRepository.findOneByLogin(managedUserDTO.getLogin()).isPresent()) {
          ...
          //Also create a people with these properties
            PeopleDTO p = new PeopleDTO();
            p.setUserId(newUser.getId());
            p.setImageUrl("test");
            p.setFollowingCount(100);
